...
class ScoreController {
    ...
    def index() {
		List scores = Score.list().collect {
			[strokes: it.strokes, rating: it.rating, slope: it.slope, playedOn: it.playedOn, differential: it.differential]
		}
		def model = [data: scores]
